 ...
 */
@Entity
public class StarSms implements Parcelable {
    public static final Creator<StarSms> CREATOR = new Creator<StarSms>() {
        @Override
        public StarSms createFromParcel(Parcel source) {
            return new StarSms(source);
        }

        @Override
        public StarSms[] newArray(int size) {
            return new StarSms[size];
        }
    };
    @Id(assignable = true)
    public long id;
    ...
    @Generated(1774839909)
    @Internal
    /** This constructor was generated by ObjectBox and may change any time. */
    public StarSms(long id, long tabsId, long conversationId, boolean isSpam, boolean isStar,
